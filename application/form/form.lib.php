<?php
# PHPFMG_ID:'20110729-face'
# Date : 20110802 09:24:06
...
define( 'PHPFMG_TO' , 'vice-president@triadindie.org' );
define( 'PHPFMG_REDIRECT', '../paypal.php' ); 

define( 'PHPFMG_ID' , '20110729-face' ); 
...
define( 'PHPFMG_SUBJECT' , "TIFN Online Application" );
define( 'PHPFMG_CC' , 'treasurer@triadindie.org' );
define( 'PHPFMG_BCC', 'webmaster@triadindie.org' );

// for auto-response email
define( 'PHPFMG_YOUR_NAME' , '' ); // name of auto-response mail address
define( 'PHPFMG_RETURN_EMAIL' , "" );  
define( 'PHPFMG_RETURN_SUBJECT' , "Thank You for Applying to Join TIFN" ); // auto-response mail subject
define( 'PHPFMG_RETURN_NO_ATTACHMENT' , '' ); // Y - No attachements will be included for auto-response email


define( 'PHPFMG_CHARSET' , 'UTF-8' );
define( 'PHPFMG_MAIL_TYPE' , 'plain text' ); // send mail in html format or plain text.
...
<!-- [Your confirmation message goes here] -->
    ...
    <b>Your application has been sent. Thank you!  Please return to www.triadindie.org</b>
    <br><br>
...
function phpfmg_mail_template(){
    ob_start();
?>
You have received an application form from %TitleOfSender% %NameOfSender%.
...
$GLOBALS['form_mail']['field_1'] = array( "name" => "field_1", "text" => "Group or Business Name",  "type" => "text", "instruction" => "", "required" => "" ) ;
$GLOBALS['form_mail']['field_2'] = array( "name" => "field_2", "text" => "Current Street Address",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_3'] = array( "name" => "field_3", "text" => "City, State, Zip Code",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_4'] = array( "name" => "field_4", "text" => "Phone Number",  "type" => "text", "instruction" => "", "required" => "Required" ) ;
$GLOBALS['form_mail']['field_5'] = array( "name" => "field_5", "text" => "Email Address",  "type" => "sender's email", "instruction" => "", "required" => "Required" ) ;
...
{ 
    ...
    $content   = '' ; 
    $style     = 'font-family:Verdana, Arial, Helvetica, sans-serif; font-size : 13px; color:#fff;padding:6px;border-bottom:1px solid #cccccc;' ;
    $tr        = array() ; // html table
    $csvValues = array();
    $cols      = array();
    $replace   = array();
...
function phpfmg_show_captcha(){
    ...
    echo "<a href='http://www.formmail-maker.com' {$onclick} title=\"Free Mail Form Tool\"><img id=\"phpfmg_captcha_image\" src=\"". $url . time() ."\"  border=0 style=\"cursor:pointer; width:79px;\" alt=\"Click the image to reload. PHP FormMail Generator at http://phpfmg.sourceforge.net\"></a>\n";
    echo "<a href='http://phpfmg.sourceforge.net' {$onclick} style=\"color:#fff; padding-left:5px;\" title=\"Reload PHP FormMail Generator Security Image\" >Reload Image</a><br>\n";
...
<!-- TIFN Membership term is yearly, beginning on January 1st of the calendar year.<br />
Membership is pro-rated if joined later in the year.<br />
<br />
TIFN Membership Rates:<br />
• $25 - individual<br />
• $12.50 - students/seniors*<br />
• $62.50 - group 2-5 members<br />
• $125 - group 6-10 member<br />
<br />
<p class="fieldtext">(* current high school or college students with school ID or other proof of enrollment/ seniors aged 65 and older with valid ID)</p>
<br />
<strong>If you wish to pay for multiple years in advance, please contact <a href="mailto:vice-president@triadindie.org">TIFN Vice-President Les Butchart</a>, for further information.</strong> -->
</div>
...
After the membership Drive, rates will be prorated monthly from Jan 1 of each year:<br />
<br />
* current high school or college students with school ID or other proof of enrollment/ seniors aged 65 and older with valid ID)<br />
<br />
YOU WILL NOW BE REDIRECTED TO THE TIFN PAYPAL PAGE TO PAY FOR YOUR MEMBERSHIP.<br />
FOR A PDF PAPER VERSION OF THE APPLICATION, OR FOR MORE INFORMATION, VISIT: http://www.triadindie.org/membership/index.htm
</div> -->
<?php
...
function phpfmg_formini(){
    return "";
}
